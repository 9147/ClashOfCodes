...
class DemoUserAdmin(admin.ModelAdmin):
    ...
    search_fields = ('name', 'role', 'team_name','id')
    list_filter = ('role', 'lunch1', 'dinner', 'breakfast', 'lunch2', 'lunch1_completed', 'dinner_completed', 'breakfast_completed', 'lunch2_completed')
